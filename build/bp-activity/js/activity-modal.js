...
var getActivityBlockEditorMessage = function getActivityBlockEditorMessage(event) {
  var feedback = event.data && event.data.message ? event.data : null;
...
document.querySelectorAll('.bp-block-activity-share a.thickbox').forEach(function (a) {
